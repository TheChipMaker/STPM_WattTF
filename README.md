...
> **Status — v0.2.0 (early but functional).**
...
| Item            | Supported in v0.2.0           | Planned                     |
|-----------------|-------------------------------|-----------------------------|
...
```ini
lib_deps =
    thechipmaker/STPM_WattTF@^0.2.0
```
...
The `owner/name@^0.2.0` form pulls the published release and automatically
accepts compatible newer versions (0.2.x and later 0.x). Pin an exact version
(`@0.2.0`) if you prefer to lock it.
